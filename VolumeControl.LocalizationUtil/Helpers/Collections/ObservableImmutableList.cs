...
namespace VolumeControl.LocalizationUtil.Helpers.Collections
{
    ...
    public abstract class ObservableCollectionObject : INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        protected virtual void OnCollectionChanged(NotifyCollectionChangedEventArgs args)
        {
            ...
            foreach (NotifyCollectionChangedEventHandler handler in notifyCollectionChangedEventHandler.GetInvocationList().Cast<NotifyCollectionChangedEventHandler>())
            {
